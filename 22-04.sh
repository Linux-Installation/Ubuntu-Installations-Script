...
pakete=`echo "$pakete synaptic krita ubuntu-restricted-extras pidgin pinta nfs-common language-pack-kde-de libdvd-pkg smartmontools unoconv mediathekview python3-axolotl python3-gnupg gnome-software gnome-software-plugin-flatpak language-pack-de fonts-sgnome-software-plugin-flatpakymbola vlc libxvidcore4 libfaac0 gnupg2 lutris dayon kate konsole element-desktop"`
